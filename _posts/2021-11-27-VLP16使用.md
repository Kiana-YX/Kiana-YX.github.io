...
2. 接口盒与电缆
   ...
   <img src="../img-post/img/VLP16jiekouhe.png" alt="image-20211204093922914" style="zoom:67%;" />
   
   电源必须能够提供高达3.0 A的电流，以适应当电源提供给传感器时，转子自旋时发生的电流浪涌。在正常运行中，传感器大约消耗8 w的功率。
   
   ![](../img-post/img/dianyuan.png)
...
1. 坐标介绍
   ...
   ![说明书](../img-post/img/202201032014114.png)
...
3. 发射时间
   ...
   ![image-20211207144440798](../img-post/img/VLP16%E5%8F%8D%E9%A6%88%E6%97%B6%E9%97%B4.png)
...
4. 实际处理速度——expected frequency: **9.921 (Hz)**
   ...
   ![](../img-post/img/202201021437044.png)

   <img src="../img-post/img/202201021438050.png" style="zoom:93%;" />

## 基本使用

1. 配置网络地址 

   ![image-20211204092911580](../img-post/img/%E9%9B%B7%E8%BE%BE%E9%85%8D%E7%BD%AE.png)

   ```
   输入192.168.1.201进行配置
   ```
	<img src="../img-post/img/202201031917272.png" style="zoom:80%;" />
...
3. 数据可视化
   ...
   ```
   ![](../img-post/img/image-20211114154849488.png)

   

   ![image-20211114155307478](../img-post/img/image-20211114155307478.png)
...
1. 运行launch文件后，查询消息（Topic）数据类型
   ...
   <img src="../img-post/img/雷达数据类型.png" style="zoom:80%;" />
...
rqt
```
![](../img-post/img/202202112005039.png)



![](../img-post/img/202202112004284.png)

显然，调整Z方向阈值8—>1.6后速度明显提升

![](../img-post/img/202202112012141.png)
